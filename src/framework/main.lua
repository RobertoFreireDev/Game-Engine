...
local spriteFileName, mapFileName, flagFileName = "spritedata", "mapData", "flagData"
...
function _init()   
    ...
    tutorialbutton = new_button(0,27,_colors.primary,10,0,20,0,0,10,10)
    tutorialbutton.clicked = function(o) changepage(tutorialeditor, o) end
    gamebutton = new_button(0,18,_colors.primary,10,0,30,0,0,10,10)
